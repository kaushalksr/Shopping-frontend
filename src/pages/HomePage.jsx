        ...
        {filteredProducts?.length > 0 ? (
          ...
          <div className="container mt-2">
            <div className="row my-3" style={{ justifyContent: "center" }}>
              ...
              <Link onClick={() => setSelectedCategory(["Women"])}
                to="/api/products"
                className="col-lg-2 col-sm-2 btn p-0"
                style={{ position: "relative", display: "inline" }}>
                {" "}
              ...
              <Link onClick={() => setSelectedCategory(["Kid"])}
                to="/api/products"
              ...
              <Link onClick={() => setSelectedCategory(["New"])}
                to="/api/products"
                className="col-lg-2 btn p-0 col-sm-2"
                style={{ position: "relative", display: "inline" }}>
                {" "}
              ...
              <Link onClick={() => setSelectedCategory(["Trending"])}
                to="/api/products"
                className="col-lg-2 btn p-0 col-sm-2"
                style={{ position: "relative", display: "inline" }}>
                {" "}
